...
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fetching The Debian 12 (Bookworm): Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0xB8B80B5B623EAB6AD8775C45B7C5D7D6350947F8
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fetching The Debian 12 (Bookworm): Security Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0x05AB90340C0C5E797F44A8C8254CF3B5AEC0A8F0
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fetching The Debian 12 (Bookworm): Stable Release Key..."
##\____________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0x4D64FEC119C2029067D6E791F8D2585B8783D481
## ----------------------------------------------------------------------------------------------------------------------------- ##
##-========================================================================-##
## 
...
##\____________________________________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0xE1CF20DDFFE4B89E802658F1E0B11894F66AEC98
## ---------------------------------------------------------------------------------------------------- ##
echo "Fetching The Debian 9 (Stretch) Security Archive Signing Key..."
##\____________________________________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0x6ED6F5CB5FA6FB2F460AE88EEDA0D2388AE22BA9


echo "Fetching The Debian 9 (Stretch) Stable Release Key..."
##\____________________________________________________________________________________________________/##
gpg --keyserver keyring.debian.org --recv-keys 0x067E3C456BAE240ACEE88F6FEF0F382A1A7B6500
...
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting  [+] Debian 12 (Bookworm): Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0xB8B80B5B623EAB6AD8775C45B7C5D7D6350947F8
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting  [+] Debian 12 (Bookworm): Security Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0x05AB90340C0C5E797F44A8C8254CF3B5AEC0A8F0
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting  [+] Debian 12 (Bookworm): Bullseye Stable Release Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0x4D64FEC119C2029067D6E791F8D2585B8783D481
## ----------------------------------------------------------------------------------------------------------------------------- ##
##-========================================================================-##
## 
...
##  
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Downloading The  [+] Debian Debian 12 (Bookworm): Bullseye Stable Release Key..."
##\____________________________________________________________________________/##
curl --verbose --progress-bar --tlsv1.2 --ssl-reqd --url https://ftp-master.debian.org/keys/release-12.asc

## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Downloading The  [+] Debian 12 (Bookworm): Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
curl --verbose --progress-bar --tlsv1.2 --ssl-reqd --url https://ftp-master.debian.org/keys/archive-key-12.asc

## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Downloading The  [+] Debian 12 (Bookworm): Security Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
curl --verbose --progress-bar --tlsv1.2 --ssl-reqd --url https://ftp-master.debian.org/keys/archive-key-12-security.asc
## 
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- ##
## ====================================================================================================================================================================== ##
...
##-===========================================================================-##
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 6 (Squeeze): Stable Release Signing Key..."
...
##-===========================================================================-##
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 7 (Wheezy): Archive Automatic Signing Key..."
##\___________________________________________________________________________/##
gpg --lsign 0xA1BD8E9D78F7FE5C3E65D8AF8B48AD6246925553
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 7 (Wheezy): Stable Release Signing Key..."
##\___________________________________________________________________________/##
...
##-===========================================================================-##
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 8 (Jessie): Archive Signing Key..."
##\___________________________________________________________________________/##
gpg --lsign 0x126C0D24BD8A2942CC7DF8AC7638D0442B90D010
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 8 (Jessie): Security Archive Signing Key..."
##\___________________________________________________________________________/##
...
##-===========================================================================-##
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 12 (Bookworm): Archive Automatic Signing Key..."
##\___________________________________________________________________________/##
gpg --lsign 0xB8B80B5B623EAB6AD8775C45B7C5D7D6350947F8
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 12 (Bookworm): Security Archive Automatic Signing Key..."
##\___________________________________________________________________________/##
gpg --lsign 0x05AB90340C0C5E797F44A8C8254CF3B5AEC0A8F0
## -------------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing  [+] Debian 12 (Bookworm): Bookworm Stable Release Key..."
##\___________________________________________________________________________/##
gpg --lsign 0x4D64FEC119C2029067D6E791F8D2585B8783D481
## -------------------------------------------------------------------------------------------------------------------------------- ##
##-===========================================================================-##
## 
...
gpg --lsign 0x0A912CDE87F9972236AF8B50363A96A5CEA9EA27
gpg --lsign 0x363A96A5CEA9EA27


echo "##-===========================================================-##"
echo "## 	[+] Find The Parrot Security - Public GPG Key on SKS Keyservers:			"
echo "##-===========================================================-##"
https://pgp.mit.edu/pks/lookup?op=get&search=0x363A96A5CEA9EA27
...
gpg --verbose --default-key 0x3BC00B17180C200A --lsign 0x03b1f286793b4009f371598f6667eb9587b02136
