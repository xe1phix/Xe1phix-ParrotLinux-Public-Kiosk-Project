...
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 10: Buster [+] Debian Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0x80D15823B7FD1561F9F7BCDDDC30D7C23CBBABEE
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 10: Buster [+] Security Archive Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0x5E61B217265DA9807A23C5FF4DFAB270CAA96DFA
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 10: Buster [+] Debian Stable Release Key..."
##\____________________________________________________________________________/##
...
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 11: Bullseye  [+] Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0x1F89983E0081FDE018F3CC9673A4F27B8DD47936
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 11: Bullseye  [+] Debian Security Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --keyid-format 0xlong --fingerprint 0xAC530D520F2F3269F5E98313A48449044AAD5C5D
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Fingerprinting The [+] Debian 11: Bullseye  [+] Stable Release Key..."
##\____________________________________________________________________________/##
...
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 10: Buster [+] Debian Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0x80D15823B7FD1561F9F7BCDDDC30D7C23CBBABEE
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 10: Buster [+] Security Archive Signing Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0x5E61B217265DA9807A23C5FF4DFAB270CAA96DFA
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 10: Buster [+] Debian Stable Release Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0x6D33866EDD8FFA41C0143AEDDCC9EFBF77E11517
## ----------------------------------------------------------------------------------------------------------------------------- ##
##-========================================================================-##
## 
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 11: bullseye  [+] Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0x1F89983E0081FDE018F3CC9673A4F27B8DD47936
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 11: bullseye  [+] Debian Security Archive Automatic Signing Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0xAC530D520F2F3269F5E98313A48449044AAD5C5D
## ---------------------------------------------------------------------------------------------------------------------------- ##
echo "Signing The [+] Debian 11: bullseye  [+] Stable Release Key..."
##\____________________________________________________________________________/##
gpg --lsign-key 0xA4285295FC7B1A81600062A9605C66F00D6C9793
## ----------------------------------------------------------------------------------------------------------------------------- ##
##-========================================================================-##
## 
