...
dc3dd hash=sha256 hwipe=/dev/sdb verb=on

dd status=progress if=/dev/urandom of=/dev/sda

dd status=progress if=/dev/urandom of=/dev/sdb

dcfldd status=on statusinterval=256 if=/dev/urandom of=/dev/sda hash=sha256 sha1log=~/dcfldd-sda.log 

dcfldd status=on statusinterval=256 if=/dev/urandom of=/dev/sdb hash=sha256 sha1log=~/dcfldd-sda.log 


nwipe --verify=last --method=zero --logfile=/home/xe1phix/nwipe.log --rounds=1 /dev/mmcblk0


dc3dd verb=on hwipe=/dev/mmcblk0

dc3dd verb=on wipe=/dev/mmcblk0
