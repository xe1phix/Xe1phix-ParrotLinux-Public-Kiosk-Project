...
##\_________________________________________/##
		|| ? || ______ ## Matched at most once.		||
		|| * || ______	 ## Zero or more times.			||
		|| + || ______ ## One or more times.			||
		|| {n}|| _____ ## Exactly n times.					||
		||{n,}|| _____ ## N or more times.				||
		||{,m}||  ____ ## Max of m times.					||
		||{n,m}||  ___ ## At least n times					||
##~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~=~##
