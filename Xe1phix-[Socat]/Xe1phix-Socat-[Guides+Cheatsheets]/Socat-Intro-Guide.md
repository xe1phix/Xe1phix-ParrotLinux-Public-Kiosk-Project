...
## Shell 2
socat -v openssl-listen:8282,cert=cert.pem,verify=0,reuseaddr,fork tcp4:localhost:8181
...
## Shell 3
socat -v openssl-listen:8383,cert=cert.pem,verify=0,reuseaddr,fork tcp4:localhost:8282
