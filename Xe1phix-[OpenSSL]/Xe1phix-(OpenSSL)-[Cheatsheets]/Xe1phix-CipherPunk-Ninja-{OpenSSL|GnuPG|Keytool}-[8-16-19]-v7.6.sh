...
##-==============================================================-##
##   [+] Connect to an SSL HTTP server the command:
##-==============================================================-##
...
openssl req -new -newkey rsa:4096 -nodes -keyout $Domain.key -out $Domain.csr -subj "/C=US/ST=Utah/L=Lehi/O=Your Company, Inc./OU=IT/CN=yourdomain.com"
...
##-=======================================================-##
p11tool --login --generate-rsa --bits 4096 --label "MyNewKey"           --outfile MyNewKey.pub "pkcs11:TOKEN-URL"
...
##-============================================================-##
tpmtool --generate-rsa --bits 4096 --outfile tpmkey.pem

##-===========================================================-##
##   [+] Generate a key that is to be stored in TPMs flash:
##-===========================================================-##
tpmtool --generate-rsa --bits 4096 --register --user
...
## Encrypts the contents of the file $plaintext.doc using DES3 in CBC mode 
## and places the resulting ciphertext into $ciphertext.bin. 
## Since no password or key parameters were specified, 
...
## using DES3 operating in OFB mode 
## and places the resulting plaintext into plaintext.doc. 
## The password "trousers" will be used to decrypt the file. 
...
## Encrypts the contents of the file $plaintext.doc 
## using the Blowfish cipher in CFB mode 
## and places the resulting ciphertext into $ciphertext.bin. 
## The contents of the environment variable PASSWORD 
## will be used for the password to generate the key.



openssl base64 -in $ciphertext.bin -out $base64.txt
## Encodes the contents of the file $ciphertext.bin in base64 
## and writes the result to the file $base64.txt.


openssl rc5 -in $plaintext.doc -out $ciphertext.bin -S C62CB1D49F158ADC -iv E9EDACA1BD7090C6 -K 89D4B1678D604FAA3DBFFD030A314B29

## Encrypts the contents of the file $plaintext.doc using the RC5 cipher in CBC mode 
## and places the resulting ciphertext into $ciphertext.bin. 
## The specified salt, key, and initialization vector 
## will be used to encrypt the plaintext. 
## Keys are specified by their hexadecimal representation.
...
## Generates a new set of Diffie-Hellman parameters 
## using a generator of 2 and a random 1,024-bit prime, 
## and writes the parameters in PEM format to the file $dhparam.pem.


openssl dhparam -in $dhparam.pem -noout -C

## Reads a set of Diffie-Hellman parameters from the file $dhparam.pem 
## and writes a C code representation of the parameters to stdout .
...
## Thelength of the prime and generator parameters will be 1,024 bits.
...
## encrypts the newly generated private key with the 3DES cipher, 
## and writes the result out to the file $dsaprivatekey.pem.
...
##-================================================================================================-##
##   [+] Generates a 1,024-bit RSA private key
##   [+] Encrypts it using 3DES 
##   [?] Using password of "trousers"
##   [?] Writes to the file $rsaprivatekey.pem.
##-================================================================================================-##
...
##-================================================================================================-##
##   [+] Reads an RSA private key from the file $rsaprivatekey.pem, 
##   [+] Decrypts it using the password "trousers", 
##   [+] Writes the corresponding public key to the file $rsapublickey.pem.
##-================================================================================================-##
...
##-================================================================================================-##
##   [?] Using the RSA public key from the file $rsapublickey.pem
##   [?] The contents of the file $plain.txt are encrypted and written to the file $Cipher.txt.
...
## Using the RSA private key from the file rsaprivatekey.pem, 
## the contents of the file cipher.txt 
## are decrypted and written to the file plain.txt.
...
## Using the RSA private key from the file rsaprivatekey.pem, 
## the contents of the file plain.txt are signed, 
## and the signature is written to the file signature.bin.
...
## Using the RSA public key from the file rsapublickey.pem, 
## the signature in the file signature.bin is verified, 
## and the original unsigned data is written out to the file plain.txt.
