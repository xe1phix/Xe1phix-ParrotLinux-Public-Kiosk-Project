...
## ############################### DPKG Aliases ################################ ##
## ============================================================================= ##
alias dpkgdepends='dpkg-deb --info '				## Queries .deb packages prereq
...
--build
--root-owner-group
--raw-extract $File.deb $Dir   ## Extract control info and files.
--ctrl-tarfile $File.deb          ## Output control tarfile.
--fsys-tarfile $File.deb          ## Output filesystem tarfile.
...
--info $File.deb         ##
--show $File.deb         ##
--contents $File.deb         ## List contents
...
echo "[+] easily trace all Nginx processes"
