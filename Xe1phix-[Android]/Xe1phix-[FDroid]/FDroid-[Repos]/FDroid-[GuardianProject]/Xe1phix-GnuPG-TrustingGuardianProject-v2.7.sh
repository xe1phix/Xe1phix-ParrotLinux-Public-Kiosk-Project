#!/bin/sh
## TrustingGuardianProject.sh


https://guardianproject.info/releases/
https://guardianproject.info/releases/KEYS

## x509 Issuer	C=US, ST=New York, L=New York, O=Guardian Project, CN=guardianproject.info/emailAddress=root@guardianproject.info
## X509 Subject	C=US, ST=New York, L=New York, O=Guardian Project, CN=guardianproject.info/emailAddress=root@guardianproject.info


gpg --verbose --keyid-format 0xlong --import KEYS
gpg --verbose --fingerprint 0xBBE20FD6DA48A3DD4CC7DF41A801183E69B37AA9
gpg --verbose --fingerprint 0x5E61C8780F86295CE17D86779F0FE587374BBE81
gpg --verbose --lsign 0xBBE20FD6DA48A3DD4CC7DF41A801183E69B37AA9
gpg --verbose --lsign 0x5E61C8780F86295CE17D86779F0FE587374BBE81
...
## Github Repository
https://github.com/guardianproject/fdroid-repo/tree/master/fdroid/repo


## Guardian Project Signing Keys
...
## For easy installation on Ubuntu/Mint/etc. 
## of our official releases, as well as backported software that we use, 
## we have an Launchpad PPA with its own signing key provided by Launchpad:
...
## We currently have two signing keys: a 4096-bit RSA key used for all new apps, 
## and a 1024-bit RSA key that we use for all apps that we first released before 2014. 
## You can download the whole public keys and verify it using the OpenPGP signature:
...
4C:B3:F5:39:F6:3B:32:AC:A1:3B:44:50:63:8D:60:5F:53:1D:4F:4A 
4CB3F539F63B32ACA13B4450638D605F531D4F4A
