...
hard_reset                  ## :PCI config reset (1 = force enable, 0 = disable (default))



tv_disable 1                    ## Disable TV-out detection (int)
modeset 0                   ## enable driver (default: auto, 0 = disabled, 1 = enabled, 2
...
cat /sys/kernel/debug/tracing/events/bpf/enable
...
filename:       /lib/modules/4.16.0-parrot5-amd64/kernel/drivers/input/mouse/appletouch.ko
