...
##-==========================================================-##
##   [+] Monitor all activity (src or dest) port 25 (SMTP).
##-==========================================================-##
ngrep -d any port 25
...
##-========================================-##
##   [+] Discover the url of media files
##-========================================-##
ngrep -lqi -p -W none ^get\|^post tcp dst port 80 -d eth0 | egrep '(flv|mp4|m4v|mov|mp3|wmv)'
