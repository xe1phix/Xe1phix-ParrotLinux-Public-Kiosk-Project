...
##-=============================================-##
##   [+] Secure Deletion (7 Wipes) of files: 
##-=============================================-##
shred --force --iterations=3 --remove=wipesync --verbose --zero $File
shred --force --iterations=3 --remove=wipesync --verbose --zero $Dir/*/*/*


##-=============================================-##
##   [+] Secure Deletion (35 passes) of files
##-=============================================-##
wipe -c -f -q -Q 3 -i $File
wipe -c -f -q -Q 3 -i -r $Dir/*/*/*
...
dc3dd corruptoutput=on verb=on wipe=/dev/sdb log=/home/$User/Downloads/OS/dc3dd-Wipe-USB-Log.txt
...
hdparm --security-erase dummy /dev/sdb
