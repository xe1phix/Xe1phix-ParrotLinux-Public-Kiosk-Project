...
youtube-dl --format 'bestvideo[height<=480]+bestaudio/best[height<=480]'

# Download best video only format but no bigger than 50 MB
youtube-dl --format 'best[filesize<50M]'

# Download best format available via direct link over HTTP/HTTPS protocol
youtube-dl --format '(bestvideo+bestaudio/best)[protocol^=http]'

# Download the best video format and the best audio format without merging them
youtube-dl --format 'bestvideo,bestaudio' -o '%(title)s.f%(format_id)s.%(ext)s'


youtube-dl --format '(bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best)[protocol^=http]'
...
youtube-dl --format 'bestvideo[ext=mp4][height<1200]+bestaudio[ext=m4a]/bestvideo[ext=webm][height<1200]+bestaudio[ext=webm]/bestvideo[height<1200]+bestaudio/best[height<1200]/best'

## Download a video using 720p video quality
youtube-dl --format 'bestvideo[height<=720]+bestaudio/best[height<=720]' 
...
youtube-dl --format bestaudio --audio-quality 0 --audio-format mp3 $URL


youtube-dl -x --format bestaudio --audio-quality 0 --audio-format mp3 $URL
...
youtube-dl --format 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4' $URL

youtube-dl --format 'bestvideo+bestaudio[ext=m4a]/bestvideo+bestaudio/best' $URL
...
youtube-dl -cit $PlaylistURL



youtube-dl --external-downloader curl
youtube-dl --external-downloader wget
youtube-dl --external-downloader 

youtube-dl --list-thumbnails
youtube-dl --write-all-thumbnails
...
-f ("bestvideo[height>=2160][ext=mp4]"/"bestvideo
[height>=1440][ext=mp4]"/"bestvideo
[height>=1080][ext=mp4]"/"bestvideo
[height>=720][ext=mp4]"/"bestvideo
[height>=480][ext=mp4]"/"bestvideo
[height>=360][ext=mp4]"/"bestvideo[ext=mp4]"/bestvideo)+bestaudio[ext=m4a]/best
...
youtube-dl --cookies /path/to/cookies/file.txt

download the best mp4 and webm formats with a height lower than 480 you can use 
youtube-dl -f '(mp4,webm)[height<480]'

youtube-dl -f '(mp4,webm)[height<720]'
