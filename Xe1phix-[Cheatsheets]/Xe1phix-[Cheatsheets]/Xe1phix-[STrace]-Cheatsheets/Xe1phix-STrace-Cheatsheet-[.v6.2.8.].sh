...
##-===============================================-##
##    [+] Trace All processes accessing /$Dir/ Directory
##-===============================================-##
strace -P /$Dir/ -p $PID
...
strace -f -e trace=network curl -LIN $Domain 
...
a thread with the CAP_SETPCAP capability 
can manipulate the -+capabilities of threads other than itself. 



/proc/[pid]/status

 file shows the capability  sets  of  a  processs
       main  thread
