...
## ----------------------------------------------------------------------- ##
##   [?] Softflowd is a flow-based network traffic anaylser 
##   [?] Capable of Cisco Netflow data export. 
##   [?] Softflowd semi-statefully tracks traffic flows recorded 
##   [?] by listening on a network interface 
##   [?] or by reading a packet capture file.
## ----------------------------------------------------------------------- ##



CISecurityCISecurity
##-===================================-##
##   [+] Start the softflowd demon
##-===================================-##
...
## ------------------------------- ##
##   [?] NFDump settings file
## ------------------------------- ##
/lib/systemd/system/nfdump.service


##-==============================-##
##   [+] Start NFDump Service
##-==============================-##
...
## ----------------------------------------------------------------------- ##
##   [?] We can see the information of each field in the next URL 
## ----------------------------------------------------------------------- ##
##   [?] https://github.com/phaag/nfdump/blob/4dafc2dc050a7371afb2e0934f7989876bfc0870/bin/parse_csv.pl
## ----------------------------------------------------------------------- ##
