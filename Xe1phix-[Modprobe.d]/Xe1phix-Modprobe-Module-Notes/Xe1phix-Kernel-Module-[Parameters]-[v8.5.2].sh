...
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/net/wireless/broadcom/b43/b43.ko
...
option usbfs_snoop_max 5000
usbfs_memory_mb 50000

modinfo usb-storage


filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/media/pci/bt8xx/bttv.ko
version:        0.9.19
license:        GPL
author:         Ralph Metzler & Marcus Metzler & Gerd Knorr
description:    bttv - v4l/v4l2 driver module for bt848/878 based cards
srcversion:     13C1ADCE9B21C4FA9433006
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/net/dns_resolver/dns_resolver.ko
license:        GPL
license:        GPL
author:         Wang Lei
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/md/dm-mirror.ko
license:        GPL
author:         Joe Thornber
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/md/dm-snapshot.ko
alias:          dm-snapshot-merge
alias:          dm-snapshot-origin
license:        GPL
author:         Joe Thornber
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/md/dm-verity.ko
license:        GPL
...
version:        1.0
srcversion:     94E54C2F21BCF973658141C
...
blacklist 
remove 
/lib/modules/4.18.0-parrot10-amd64/kernel/net/nfc/nfc_digital.ko


nfc                                   ## NFC Core ver 0.1  
alias net-pf-39
blacklist 
remove 
/lib/modules/4.18.0-parrot10-amd64/kernel/net/nfc/nfc.ko
...
name:           applicom
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/char/applicom.ko
parm:           irq:IRQ of the Applicom board (uint)
parm:           mem:Shared Memory Address of Applicom board (ulong)



cfg80211
/lib/modules/4.18.0-parrot10-amd64/kernel/net/wireless/cfg80211.ko
...
name:           mac80211                ## IEEE 802.11 subsystem
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/net/mac80211/mac80211.ko
...
md_mod          ## MD RAID framework
parm:           start_dirty_degraded:int
parm:           create_on_open:bool


stkwebcam       ## Syntek DC1125 webcam driver
/lib/modules/4.18.0-parrot10-amd64/kernel/drivers/media/usb/stkwebcam/stkwebcam.ko
parm:           hflip:Horizontal image flip (mirror). Defaults to 0 (int)
parm:           vflip:Vertical image flip. Defaults to 0 (int)
parm:           debug:Debug v4l ioctls. Defaults to 0 (int)

blocklist stkwebcam         ## Syntek DC1125 webcam driver
remove stkwebcam
...
parm:           auto_remove_rfkill:Automatically remove rfkill devices when other modules start receiving events from this module and re-add them when the last module stops receiving events (default true) (bool)


msi_laptop      ## MSI Laptop Support
parm:           force:Force driver load, ignore DMI data (bool)
parm:           auto_brightness:Enable automatic brightness control (0: disabled; 1: enabled; 2: don't touch) (int)
...
/lib/modules/4.18.0-parrot10-amd64/kernel/drivers/md/dm-verity.ko
parm:           reserved_rq_based_ios:Reserved IOs in request-based mempools (uint)
parm:           use_blk_mq:Use block multiqueue for request-based DM devices (bool)
parm:           dm_mq_nr_hw_queues:Number of hardware queues for request-based dm-mq devices (uint)
parm:           dm_mq_queue_depth:Queue depth for request-based dm-mq devices (uint)
...
dm_verity       ## device-mapper target for transparent disk integrity checking
parm:           prefetch_cluster:uint


dm_snapshot     ## device-mapper snapshot target
parm:           snapshot_copy_throttle:A percentage of time allocated for copy on write (uint)


dm_persistent_data      ## Immutable metadata library for dm
/lib/modules/4.18.0-parrot10-amd64/kernel/drivers/md/persistent-data/dm-persistent-data.ko
...
parm:           wlan_status:Set the wireless status on boot (0 = disabled, 1 = enabled, -1 = dont do anything). default is -1 (int)
parm:           bluetooth_status:Set the wireless status on boot (0 = disabled, 1 = enabled, -1 = dont do anything). default is -1 (int)
parm:           wimax_status:Set the wireless status on boot (0 = disabled, 1 = enabled, -1 = dont do anything). default is -1 (int)
parm:           wwan_status:Set the wireless status on boot (0 = disabled, 1 = enabled, -1 = dont do anything). default is -1 (int)
...
options thinkpad_acpi bluetooth 
...
modinfo hfi1
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/infiniband/hw/hfi1/hfi1.ko
...
restricted          ## Restrict fan control and serial number to CAP_SYS_ADMIN
fan_max autodetect
...
mst:Enable DisplayPort multi-stream
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/usb/serial/garmin_gps.ko
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/parport/parport_pc.ko
...
/lib/modules/4.18.0-parrot10-amd64/kernel/drivers/scsi/scsi_transport_fc.ko
...
/lib/modules/4.18.0-parrot10-amd64/kernel/drivers/scsi/scsi_transport_iscsi.ko
...
options scan none
## options scsi_logging_level


name:           scsi_debug
description:    SCSI debug adapter driver
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/scsi/scsi_debug.ko
...
parm:           inq_vendor:SCSI INQUIRY vendor string (def="Linux") (string)
parm:           inq_product:SCSI INQUIRY product string (def="scsi_debug") (string)
parm:           inq_rev:SCSI INQUIRY revision string (def="0188") (string)
parm:           lbpu:enable LBP, support UNMAP command (def=0) (int)
parm:           lbpws:enable LBP, support WRITE SAME(16) with UNMAP bit (def=0) (int)
parm:           lbpws10:enable LBP, support WRITE SAME(10) with UNMAP bit (def=0) (int)
parm:           lbprz:on read unmapped LBs return 0 when 1 (def), return 0xff when 2 (int)
...
parm:           max_luns:number of LUNs per target to simulate(def=1) (int)
parm:           max_queue:max number of queued commands (1 to max(def)) (int)
parm:           medium_error_start:starting sector number to return MEDIUM error (int)
parm:           medium_error_count:count of sectors to return follow on MEDIUM error (int)
parm:           ndelay:response delay in nanoseconds (def=0 -> ignore) (int)
parm:           no_lun_0:no LU number 0 (def=0 -> have lun 0) (int)
parm:           no_uld:stop ULD (e.g. sd driver) attaching (def=0)) (int)
parm:           num_parts:number of partitions(def=0) (int)
...
guard           ## protection checksum: 0=crc, 1=ip
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/usb/storage/usb-storage.ko
...
filename:       /lib/modules/4.18.0-parrot10-amd64/kernel/drivers/staging/wlan-ng/prism2_usb.ko

parm:           wlan_watchdog:transmit timeout in milliseconds (int)
parm:           wlan_wext_write:enable write wireless extensions (int)
parm:           prism2_doreset:Issue a reset on initialization (int)
parm:           prism2_reset_holdtime:reset hold time in ms (int)
parm:           prism2_reset_settletime:reset settle time in ms (int)
...
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/fs/cifs/cifs.ko
...
name:           xen_scsiback
description:    Xen SCSI backend driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/xen-scsiback.ko
...
name:           xen_privcmd
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/xen-privcmd.ko
...
name:           xen_gntdev
description:    User-space granted page access driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/xen-gntdev.ko
parm:           limit:Maximum number of grants that may be mapped by the gntdev device (int)


name:           xen_gntalloc
description:    User-space grant reference allocator driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/xen-gntalloc.ko
parm:           limit:Maximum number of grants that may be allocated by the gntalloc device (int)


name:           xen_acpi_processor
description:    Xen ACPI Processor P-states (and Cx) driver which uploads PM data to Xen hypervisor
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/xen-acpi-processor.ko
parm:           off:Inhibit the hypercall. (int)


name:           tmem
description:    Shim to Xen transcendent memory
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/xen/tmem.ko
parm:           frontswap:bool
...
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/ata/



name:           tcm_fc
description:    FC TCM fabric driver 0.4
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/target/tcm_fc/tcm_fc.ko
parm:           debug_logging:a bit mask of logging levels (int)



name:           tcm_loop
description:    TCM loopback virtual Linux/SCSI fabric module
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/target/loopback/tcm_loop.ko



name:           scsi_transport_iscsi
description:    iSCSI Transport Interface
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/scsi/scsi_transport_iscsi.ko
...
name:           usbserial
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/usb/serial/usbserial.ko
...
cls_bpf                 ## TC BPF based classifier
cls_bpf                 ## 
cls_fw                 ## 
...
└──╼ $modinfo /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/hid/
Display all 100 possibilities? (y or n)
hid-a4tech.ko           hid-elo.ko              hid-lenovo.ko           hid-retrode.ko          hid-speedlink.ko
hid-accutouch.ko        hid-emsff.ko            hid-logitech-dj.ko      hid-rmi.ko              hid-steam.ko
hid-alps.ko             hid-ezkey.ko            hid-logitech-hidpp.ko   hid-roccat-arvo.ko      hid-steelseries.ko
hid-appleir.ko          hid-gaff.ko             hid-logitech.ko         hid-roccat-common.ko    hid-sunplus.ko
hid-apple.ko            hid-gembird.ko          hid-magicmouse.ko       hid-roccat-isku.ko      hid-tivo.ko
hid-asus.ko             hid-generic.ko          hid-mf.ko               hid-roccat.ko           hid-tmff.ko
hid-aureal.ko           hid-gyration.ko         hid-microsoft.ko        hid-roccat-kone.ko      hid-topseed.ko
hid-axff.ko             hid-holtekff.ko         hid-monterey.ko         hid-roccat-koneplus.ko  hid-twinhan.ko
hid-belkin.ko           hid-holtek-kbd.ko       hid-multitouch.ko       hid-roccat-konepure.ko  hid-uclogic.ko
hid-betopff.ko          hid-holtek-mouse.ko     hid-nti.ko              hid-roccat-kovaplus.ko  hid-udraw-ps3.ko
hid-cherry.ko           hid-hyperv.ko           hid-ntrig.ko            hid-roccat-lua.ko       hid-waltop.ko
hid-chicony.ko          hid-icade.ko            hid-ortek.ko            hid-roccat-pyra.ko      hid-wiimote.ko
hid-cmedia.ko           hid-ite.ko              hid-penmount.ko         hid-roccat-ryos.ko      hid-xinmo.ko
hid-corsair.ko          hid-jabra.ko            hid-petalynx.ko         hid-roccat-savu.ko      hid-zpff.ko
hid-cougar.ko           hid-kensington.ko       hid-picolcd.ko          hid-saitek.ko           hid-zydacron.ko
hid-cp2112.ko           hid-keytouch.ko         hid-plantronics.ko      hid-samsung.ko          i2c-hid/
hid-cypress.ko          hid.ko                  hid-pl.ko               hid-sensor-custom.ko    intel-ish-hid/
hid-dr.ko               hid-kye.ko              hid-primax.ko           hid-sensor-hub.ko       uhid.ko
hid-elan.ko             hid-lcpower.ko          hid-prodikeys.ko        hid-sjoy.ko             usbhid/
hid-elecom.ko           hid-led.ko              hid-redragon.ko         hid-sony.ko             wacom.ko



name:           hid
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/hid/hid.ko
parm:           debug:toggle HID debugging messages (int)
parm:           ignore_special_drivers:Ignore any special drivers and handle all devices by generic driver (int)
...
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/hid/hid-apple.ko
parm:           fnmode:Mode of fn key on Apple keyboards (0 = disabled, [1] = fkeyslast, 2 = fkeysfirst) (uint)
parm:           iso_layout:Enable/Disable hardcoded ISO-layout of the keyboard. (0 = disabled, [1] = enabled) (uint)
parm:           swap_opt_cmd:Swap the Option ("Alt") and Command ("Flag") keys. (For people who want to keep Windows PC keyboard muscle memory. [0] = as-is, Mac layout. 1 = swapped, Windows layout.) (uint)
...
hid_appleir
description:    HID Apple IR remote controls
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/hid/hid-appleir.ko



name:           usb_wwan
description:    USB Driver for GSM modems
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/usb/serial/usb_wwan.ko


name:           usbnet
description:    USB network driver framework
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/net/usb/usbnet.ko
parm:           msg_level:Override default message level (int)


name:           usbip_core
description:    USB/IP Core
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/usb/usbip/usbip-core.ko
...
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/usb/usbip/usbip-host.ko


name:           usbip_vudc
description:    USB over IP Device Controller
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/usb/usbip/usbip-vudc.ko
parm:           num:number of emulated controllers (uint)
...
name:           xen_blkback
vermagic:       4.19.0-parrot4-28t-amd64 SMP mod_unload modversions 
parm:           max_buffer_pages:Maximum number of free pages to keep in each block backend buffer (int)
parm:           max_persistent_grants:Maximum number of grants to map persistently (int)
parm:           persistent_grant_unused_seconds:Time in seconds an unused persistent grant is allowed to remain allocated. Default is 60, 0 means unlimited. (uint)
parm:           max_queues:Maximum number of hardware queues per virtual disk.By default it is the number of online CPUs. (uint)
...
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/acerhdf.ko
...
name:           acer_wmi
description:    Acer Laptop WMI Extras Driver
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/acer-wmi.ko
...
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/asus-laptop.ko
...
name:           dell_laptop
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/dell-laptop.ko
parm:           force_rfkill:enable rfkill on non whitelisted models (bool)
...
name:           dell_rbtn
description:    Dell Airplane Mode Switch driver
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/dell-rbtn.ko
parm:           auto_remove_rfkill:Automatically remove rfkill devices when other modules start receiving events from this module and re-add them when the last module stops receiving events (default true) (bool)
...
name:           dell_rbtn
description:    Dell Airplane Mode Switch driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/dell-rbtn.ko
parm:           auto_remove_rfkill:Automatically remove rfkill devices when other modules start receiving events from this module and re-add them when the last module stops receiving events (default true) (bool)


name:           eeepc_wmi
description:    Eee PC WMI Hotkey Driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/eeepc-wmi.ko
parm:           hotplug_wireless:Enable hotplug for wireless device. If your laptop needs that, please report to acpi4asus-user@lists.sourceforge.net. (bool)
...
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/fujitsu-laptop.ko
parm:           use_alt_lcd_levels:Interface used for setting LCD brightness level (-1 = auto, 0 = force SBLL, 1 = force SBL2) (int)
parm:           disable_brightness_adjust:Disable LCD brightness adjustment (bool)
...
name:           gpd_pocket_fan
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/gpd-pocket-fan.ko
parm:           temp_limits:Millicelsius values above which the fan speed increases (array of int)
parm:           hysteresis:Hysteresis in millicelsius before lowering the fan speed (int)
parm:           speed_on_ac:minimum fan speed to allow when system is powered by AC (int)




name:           ibm_rtl
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/ibm_rtl.ko
parm:           force:Force driver load, ignore DMI data (bool)
parm:           debug:Show debug output (bool)
...
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/ideapad-laptop.ko
...
description:    Intel Oaktrail Platform ACPI Extras
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/intel_oaktrail.ko
parm:           force:Force driver load, ignore DMI data (bool)


name:           msi_laptop

description:    MSI Laptop Support
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/msi-laptop.ko
parm:           force:Force driver load, ignore DMI data (bool)
parm:           auto_brightness:Enable automatic brightness control (0: disabled; 1: enabled; 2: don't touch) (int)
...
name:           samsung_laptop
description:    Samsung Backlight driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/samsung-laptop.ko
parm:           force:Disable the DMI check and forces the driver to be loaded (bool)
parm:           debug:Debug enabled or not (bool)
...
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/sony-laptop.ko
...
surfacepro3_button
description:    Surface Pro3 Button Driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/surfacepro3_button.ko


name:           wmi
description:    ACPI-WMI Mapping Driver
/lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/platform/x86/wmi.ko
...
name:           scsi_debug
description:    SCSI debug adapter driver
filename:       /lib/modules/4.19.0-parrot4-28t-amd64/kernel/drivers/scsi/scsi_debug.ko
...
parm:           max_dcc_channels:max number of expected DCC channels per IRC session (uint)
parm:           dcc_timeout:timeout on for unestablished DCC channels (uint)


name:           overlay
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/overlayfs/overlay.ko
...
parm:           permit_mounts_in_userns:Permit mounts in user namespaces (bool)
parm:           metacopy:bool
parm:           ovl_metacopy_def:Default to on or off for the metadata only copy up feature


name:           ramoops
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/pstore/ramoops.ko
parm:           record_size:size of each dump done on oops/panic (ulong)
parm:           console_size:size of kernel console log (ulong)
parm:           ftrace_size:size of ftrace log (ulong)
parm:           pmsg_size:size of user space message log (ulong)
...
parm:           dump_oops:set to 1 to dump oopses, 0 to only dump panics (default 1) (int)
parm:           ecc:int
parm:           ramoops_ecc:if non-zero, the option enables ECC support and specifies ECC buffer size in bytes (1 is a special value, means 16 bytes ECC)


name:           kafs        ## AFS Client File System
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/afs/kafs.ko
parm:           debug:AFS debugging mask (uint)
parm:           rootcell:root AFS cell name and VL server IP addr list (charp)


name:           cachefiles              ## Mounted-filesystem based cache
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/cachefiles/cachefiles.ko
parm:           debug:uint
parm:           cachefiles_debug:CacheFiles debugging mask
...
name:   nfs_layout_nfsv41_files         ## The NFSv4 file layout driver
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/nfs/filelayout/nfs_layout_nfsv41_files.ko
...
name:   nfs_layout_flexfiles        ## The NFSv4 flexfile layout driver
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/nfs/flexfilelayout/nfs_layout_flexfiles.ko
parm:           dataserver_retrans:The  number of times the NFSv4.1 client retries a request before it attempts further  recovery  action. (uint)
parm:           dataserver_timeo:The time (in tenths of a second) the NFSv4.1  client  waits for a response from a  data server before it retries an NFS request. (uint)



name:   nfsv4           ## Network Filesystem Version 4
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/nfs/nfsv4.ko
parm:           layoutstats_timer:uint


name:   nfsd
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/nfsd/nfsd.ko
parm:           cltrack_prog:Path to the nfsdcltrack upcall program (string)
parm:           cltrack_legacy_disable:Disable legacy recoverydir conversion. Default: false (bool)
parm:           nfs4_disable_idmapping:Turn off server's NFSv4 idmapping when using 'sec=sys' (bool)
...
name:   auth_rpcgss
/lib/modules/4.18.0-parrot10-amd64/kernel/net/sunrpc/auth_gss/auth_rpcgss.ko
parm:           expired_cred_retry_delay:Timeout (in seconds) until the RPC engine retries an expired credential (uint)
parm:           key_expire_timeo:Time (in seconds) at the end of a credential keys lifetime where the NFS layer cleans up prior to key expiration (uint)


name:   sunrpc
/lib/modules/4.18.0-parrot10-amd64/kernel/net/sunrpc/sunrpc.ko
...
name:   lockd       ## NFS file locking service version 0.5.
/lib/modules/4.18.0-parrot10-amd64/kernel/fs/lockd/lockd.ko
parm:           nsm_use_hostnames:bool
parm:           nlm_max_connections:uint


name:   rxrpc       ## RxRPC network protocol
/lib/modules/4.18.0-parrot10-amd64/kernel/net/rxrpc/rxrpc.ko
parm:           debug:RxRPC debugging mask (uint)



name:   dns_resolver
/lib/modules/4.18.0-parrot10-amd64/kernel/net/dns_resolver/dns_resolver.ko
parm:           debug:DNS Resolver debugging mask (uint)
...
parm:           isoc_mode: Set the default format for ISOC endpoint.  Default: 0x60 (Compression On) (int)
...
parm:           adjust_compression: Set the ADPCM compression for the device.  Default: 1 (On) (int)
parm:           switch_svideo_input: Set the S-Video input.  Some cables and input device are wired differently. Default: 0 (Off) (int)
parm:           adjust_x_offset:adjust X offset display [core] (int)
parm:           adjust_y_offset:adjust Y offset display [core] (int)


nf_log_ipv4.ko nf_log_arp.ko nf_conntrack_ipv4.ko

install sha512_generic
...
install sha512_ssse3
## /lib/modules/4.18.0-parrot10-amd64/kernel/arch/x86/crypto/aes-x86_64.ko
crypto-sha512
crypto-sha512-avx2
sha512-avx2
crypto-sha512-avx
...
install sha256_ssse3
alias crypto-sha256
alias crypto-sha256-avx
alias crypto-sha256-avx2
...
name:           tcrypt
vermagic:       5.10.0-8parrot1-amd64 SMP mod_unload modversions 
parm:           alg:charp
parm:           type:uint
parm:           mask:uint
parm:           mode:int
